...
//  Midtrans
//
//  Created by zein rezky chandra on 08/12/19.
...
class ViewController: UIViewController {
	...
	private func addGradient(with red: CGFloat, green: CGFloat, blue: CGFloat) {
		...
		//BUG
		//The bug is that the gradient layer's frame is not being set correctly. I'm using bounds in my code instead.
		// The fix is on line 32
	...
	func updateCardNumber() {
		...
		self.cardLengthInfoLabel.text = "Card Number Length: \(self.cardNumber.count)"
